...
path_to_results = 'src/evaluation/analyses/europe/forecast_horizons_persistence' # None
...
def process_input_target(i):
    result = evaluation_module.iterate_initial_time_skillscore_target(i)
    return result
...
if __name__ == '__main__':
    ...
    time_idxs = 1350 # + dataset.lookback  #(dataset.time_size)
    ...
    print(np.vstack(scores_total).shape)
